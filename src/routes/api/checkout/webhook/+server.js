						...
						if (metadataObject) {
							...
							context.waitUntil(
								env.MESSENGER_QUEUE.send({
									contextMessage: `generate a succinct poem telling ${order.name.split(' ')[0]} that they are have ${quantity} ticket(s) to Bazaar on May 2nd @ The Faight Collective 7pm to midnight. It is important that the details of the show and tickets are accurate`,
